...
class FilterDialogFragment(
    ...
    private fun setupClickListeners(view: View) {
        ...
        buttonSearch.setOnClickListener {
            val selectedManufacturer = (spinnerManufacturer.selectedItem as Manufacturer).slug
            val selectedMake = (spinnerMake.selectedItem as Make).slug
            val selectedScale = (spinnerScale.selectedItem as Scale).slug
            viewModel.filter(
